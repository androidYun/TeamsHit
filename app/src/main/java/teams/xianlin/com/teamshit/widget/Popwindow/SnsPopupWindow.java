...
public class SnsPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public SnsPopupWindow(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.popupwindow_social_sns_layout, null);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.digBtn:
                mItemClickListener.onItemClick(digBtn, mActionItems.get(0), 0);
                break;
            case R.id.commentBtn:
                mItemClickListener.onItemClick(commentBtn, mActionItems.get(1), 1);
                break;
            default:
                break;
        }
    ...
    public static interface OnItemClickListener {
        public void onItemClick(View view, ActionItem item, int position);
    }
