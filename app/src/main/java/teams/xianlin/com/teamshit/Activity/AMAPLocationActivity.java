...
public class AMAPLocationActivity extends BaseActivity implements View.OnClickListener, LocationSource, GeocodeSearch.OnGeocodeSearchListener, AMapLocationListener, AMap.OnCameraChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navi_top = (TitleNavi) findViewById(R.id.navi_top);
        navi_top.setBackTitle(getResources().getString(R.string.geographical_position));
        navi_top.setFinish("确定");
        mapView = (MapView) findViewById(R.id.map);
        mapView.onCreate(savedInstanceState);
        navi_top.setClickCallBack(this);
    ...
    public void onRegeocodeSearched(RegeocodeResult regeocodeResult, int i) {
        if (i == 0) {
            if (regeocodeResult != null && regeocodeResult.getRegeocodeAddress() != null) {
                ...
                LogUtil.e("LocationChange", shortAdd + latitude + "----" + longitude);
            } else {
                ToastUtil.show(AMAPLocationActivity.this, "没有搜索到结果");
            }
        } else {
            ToastUtil.show(AMAPLocationActivity.this, "搜索失败,请检查网络");
        }
    }
    ...
    public void onLocationChanged(AMapLocation aMapLocation) {
        if (aMapLocation != null && aMapLocation.getAMapException().getErrorCode() == 0) {
            ...
            LogUtil.e("LocationInit", aMapLocation.getRoad() + aMapLocation.getStreet() + aMapLocation.getPoiName() + latitude + "----" + longitude);
