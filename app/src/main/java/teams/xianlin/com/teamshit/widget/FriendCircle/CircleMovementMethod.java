...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod() {
        this.textViewBgColor = TeamsHitApplication.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = TeamsHitApplication.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
